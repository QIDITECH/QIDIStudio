...
public:
    ...
    //QDS: Returns true if the number was parsed correctly into out and the number spanned the whole input string.
...
private:
    ...
    //QDS: use these value to save information from comment
