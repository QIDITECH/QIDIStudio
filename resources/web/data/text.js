var LangText={
	"en": {
		...
		"t150": "Select All",
		"t151": "Terms of QIDI Tech User Experience Improvement Program",
		"t152": "In the 3D Printing community, we learn from each other’s successes and failures to refine our slicing parameters and settings. QIDI Studio follows the same principle, learning from the collective successes and challenges of our users to continuously improve performance.",
		"t153": "To help us improve the quality and performance of our products and service, QIDI Studio sincerely invites you to join the User Experience Improvement Program. This document explains what data will be collected under the program and how it will be used. We kindly ask you to carefully read and fully understand this document before providing your consent. You may withdraw your consent at any time by changing the settings in \"Preferences – User Experience.\"",
		...
		"t170": "QIDI Tech is committed to protecting your privacy. The information collected will not be shared or disclosed to any third parties except as required by applicable law. Data will be retained only for the period necessary to fulfill the purposes described, unless a longer retention period is required by law. For more information on how we handle your data, please see our",
		"t171": "Privacy Notice",
	...
	"zh_CN": {
		...
		"t52": "忽略",
		"t53": "同意",
		"t54": "通过学习真实打印过程中的成功与失败经验，QIDI Studio能够持续提升打印质量、稳定性和整体性能。<br/><br/><span style='display:inline-block;width:2em;'></span>如果您选择加入本计划，您的打印机和软件将向我们发送您的使用数据和性能数据，例如关于设备信息、设置、连接情况及打印行为的数据，以帮助我们更快发现问题和改进我们的产品与服务。<br/><br/><span style='display:inline-block;width:2em;'></span>本计划为自愿参与，您可以随时在“偏好设置 > 用户体验”中退出本计划。更多信息请参阅",
		"t55": "《用户体验改进计划》",
		"t56": "页面。",
		"t57": "",
		"t58": "",
		...
		"t150": "全选",
		"t151": "起迪用户体验改进计划",
		"t152": "在3D打印社区，我们从彼此的成功和失败中学习来优化自己的切片参数和设置。QIDI Studio道循同样原则，从广大用户打印的成功和失败中学习经验，改进我们的产品和服务。",
		"t153": "为了帮助我们改进产品和服务的质量，提升您的用户体验，QIDI Studio邀请您加入我们的用户体验改进计划，请您认真阅读和充分理解本计划内容。<br/><span style='display:inline-block;width:2em;'></span>您知悉并同意，当您加入本计划时，已经充分理解并完全同意本计划内容。您可以随时按照本计划“如何退出”中说明的方法退出本计划。",
		"t154": "关于信息收集与使用",
	...
	"ja_JP": {
		...
		"t150": "すべて選択",
		"t151": "QIDI Tech ユーザーエクスペリエンス向上プログラムの利用規約",
		"t152": "3D プリントのコミュニティでは、お互いの成功例と失敗例を共有して学び合い、スライスのパラメータや設定をより良いものにしていく文化があります。QIDI Studio も同じ原則に従い、ユーザーのみなさんの成功例や課題から学びながら、継続的な性能の向上に取り組んでいます。",
		"t153": "今後もより良い品質・性能の製品およびサービスをお届けするため、QIDI Studio のユーザー エクスペリエンス向上プログラムにぜひご参加ください。本ドキュメントでは、本プログラムで収集するデータとその利用方法について説明します。ご同意いただく前に、本ドキュメントの内容をよくお読みいただき、十分にご理解くださいますようお願いいたします。「設定 - ユーザーエクスペリエンス」で設定を変更すると、同意はいつでも撤回することが可能です。",
		"t154": "情報の収集と利用方法について",
		...
		"t169": "プライバシー保護",
		"t170": "QIDI Tech は、お客様のプライバシー保護に取り組んでいます。収集した情報は、適用法で求められる場合を除き、第三者と共有または開示されることはありません。データは、本ドキュメントに記載された目的を達成するために必要な期間のみ保持し、法律によってより長い保存期間が求められる場合を除き、それ以上保持することはありません。お客様のデータの取り扱いについては、当社の",
		"t171": "プライバシー ポリシー",
		"wk17": "バンブーラボ アカデミー",
	...
	"it_IT": {
		...
		"t52": "Ignora",
		"t53": "Unisciti",
		"t54": "Grazie all'analisi delle stampe reali, inclusi successi ed errori, QIDI Studio può migliorare la qualità di stampa, l'affidabilità e le prestazioni complessive.<br/><br/><span style='display:inline-block;width:2em;'></span>Aderendo al programma, la stampante e il software condivideranno dati relativi all'utilizzo e alle prestazioni, tra cui informazioni sul dispositivo, impostazioni, connettività e comportamento di stampa. Questo ci consente di individuare più rapidamente eventuali problemi e migliorare i nostri prodotti.<br/><br/><span style='display:inline-block;width:2em;'></span>La partecipazione è facoltativa ed è possibile uscire dal programma in qualsiasi momento da <b>Preferenze &gt; Esperienza utente</b>. Per ulteriori dettagli, visita la pagina del ",
		...
		"t151": "Termini del Programma di miglioramento dell'esperienza utente di QIDI Tech",
		"t152": "All'interno della comunità della stampa 3D, la condivisione di successi e fallimenti ci permette di ottimizzare costantemente i parametri e le impostazioni di slicing. QIDI Studio adotta lo stesso approccio, traendo insegnamento dalle esperienze e dalle sfide dei nostri utenti per ottimizzare costantemente le prestazioni del software.",
		"t153": "Per aiutarci a migliorare la qualità e le prestazioni dei nostri prodotti e servizi, QIDI Studio ti invita a partecipare al Programma di miglioramento dell'esperienza utente. Questo documento descrive quali dati verranno raccolti nell'ambito del programma e in che modo verranno utilizzati. Ti chiediamo di leggere attentamente e comprendere appieno questo documento prima di fornire il tuo consenso. Puoi revocare il tuo consenso in qualsiasi momento modificando le impostazioni in \"Preferenze – Esperienza utente\".",
	...
	"fr_FR": {
		...
		"t151": "Conditions générales du programme d'amélioration de l'expérience utilisateur de QIDI Tech",
		"t152": "Dans la communauté de l'impression 3D, nous apprenons des succès et des échecs des uns et des autres pour affiner nos paramètres et réglages de tranchage. QIDI Studio suit le même principe, en tirant des leçons des succès et des défis collectifs de ses utilisateurs pour améliorer continuellement ses performances.",
		"t153": "Pour nous aider à améliorer la qualité et les performances de nos produits et services, QIDI Studio a le plaisir de vous inviter à rejoindre le Programme d'amélioration de l'expérience utilisateur. Ce document explique quelles données seront collectées dans le cadre de ce programme et comment elles seront utilisées. Nous vous prions de lire attentivement ce document et de bien le comprendre avant de donner votre consentement. Vous pouvez retirer votre consentement à tout moment en modifiant les paramètres dans « Préférences – Expérience utilisateur ».",
	...
	"de_DE": {
		...
		"t150": "Alle auswählen",
		"t151": "Teilnahmebedingungen für das QIDI Tech-Programm zur Verbesserung der Benutzererfahrung",
		"t152": "In der 3D-Druck-Community lernen wir aus den Erfolgen und Misserfolgen der anderen, um unsere Parameter und Einstellungen für Slicen zu verfeinern. QIDI Studio verfolgt das gleiche Prinzip und lernt aus den gemeinsamen Erfolgen und Herausforderungen seiner Nutzer, um die Leistung kontinuierlich zu verbessern.",
		"t153": "Zur Verbesserung der Qualität und Leistung unserer Produkte und Dienste lädt QIDI Studio Sie herzlich ein, am Programm zur Verbesserung der Benutzererfahrung teilzunehmen. In diesem Dokument wird erläutert, welche Daten im Rahmen des Programms erfasst und wie diese genutzt werden. Wir bitten Sie, dieses Dokument sorgfältig zu lesen und vollständig zu verstehen, bevor Sie Ihre Zustimmung erteilen. Sie können Ihre Zustimmung jederzeit widerrufen, indem Sie die Einstellungen unter „Einstellungen – Benutzererfahrung“ ändern.",
	...
	"hu_HU": {
		...
		"t151": "A QIDI Tech felhasználói élmény javítására szolgáló programjának feltételei",
		"t152": "A 3D Printing közösség célja, hogy tanuljunk egymás sikereiből és kudarcaiból, és folyamatosan fejlesszük a szeletelési paramétereket és beállításokat. A QIDI Studio ugyanerre az elvre épül: levonjuk a tapasztalatokat a kollektív sikerek és nehézségek tapasztalatait, és a teljesítmény folyamatos javítására ösztönözzük a felhasználóinkat.",
		"t153": "A termékeink és a szolgáltatásaink minőségének és teljesítményének javítása érdekében a QIDI Studio Önt is meghívja a felhasználói élmény fejlesztését célzó programba. Ebben a dokumentumban leírjuk, hogy milyen adatokat gyűjtünk a program keretében, és hogyan használjuk fel őket. Kérjük, hogy mielőtt megadja a hozzájárulását, olvassa végig figyelmesen, majd értelmezze ezt a dokumentumot. A hozzájárulást bármikor visszavonhatja, ehhez módosítsa a „Beállítások – Felhasználói élmény” menüpontban található beállításokat.",
	...
	"es_ES": {
		...
		"t151": "Condiciones del Programa de mejora de la experiencia del usuario de QIDI Tech",
		"t152": "En la comunidad de impresión 3D, aprendemos de los éxitos y fracasos de los demás para mejorar nuestros parámetros y ajustes de corte. QIDI Studio sigue el mismo principio: aprender de los éxitos y desafíos conjuntos de nuestros usuarios para mejorar continuamente el rendimiento.",
		"t153": "Para ayudarnos a mejorar la calidad y el rendimiento de nuestros productos y servicios, QIDI Studio te invita a participar en el Programa de mejora de la experiencia del usuario. En este documento se explica qué datos se recopilarán en el marco del programa y cómo se utilizarán. Te pedimos que leas atentamente y comprendas completamente este documento antes de proporcionar tu consentimiento. Puedes retirar tu consentimiento en cualquier momento cambiando la configuración en \"Preferencias – Experiencia de usuario\".",
	...
	"sv_SE": {
		...
		"t150": "Markera alla",
		"t151": "Villkor för QIDI Tech program för förbättring av användarupplevelsen",
		"t152": "I 3D-utskriftsbranschen lär vi oss av varandras framgångar och misslyckanden för att förbättra våra skivningsparametrar och -inställningar. QIDI Studio följer samma princip, och lär sig av våra användares gemensamma framgångar och utmaningar för att kontinuerligt förbättra prestandan.",
		"t153": "För att hjälpa oss förbättra våra produkters och tjänsters kvalitet och prestanda bjuder nu QIDI Studio in dig varmt till att delta i programmet för förbättring av användarupplevelsen. I detta dokument förklaras vilka data som kommer att samlas in i programmet och hur dessa kommer att användas. Vi ber dig att noga läsa och förstå detta dokument innan du ger ditt samtycke. Du kan när som helst återkalla ditt samtycke genom att ändra inställningarna i ”Preferences – User Experience” (Inställningar – Användarupplevelse).",
		...
		"t170": "QIDI Tech är inriktade på att skydda din integritet. Den information som samlas in kommer inte att delas eller lämnas ut till någon tredje part, utom i den utsträckning som krävs enligt tillämplig lag. Data kommer endast att lagras under den period som är nödvändig för att uppfylla de beskrivna syftena, såvida inte en längre lagringsperiod krävs enligt lag. För mer information om hur vi hanterar dina data, se vår ",
		"t171": "integritetspolicy",
		"wk17": "QIDI TechAkademin",
	...
	"nl_NL": {
		...
		"t151": "Voorwaarden van het QIDI Lab-programma voor verbetering van de gebruikerservaring",
		"t152": "Binnen de 3D-printgemeenschap leren we van elkaars successen en mislukkingen om onze slice-parameters en -instellingen te verfijnen. QIDI Studio hanteert hetzelfde principe: we leren van de gezamenlijke successen en uitdagingen van onze gebruikers om de prestaties continu te verbeteren.",
		"t153": "Om ons te helpen de kwaliteit en prestaties van onze producten en diensten te verbeteren, nodigt QIDI Studio u van harte uit om deel te nemen aan het programma voor verbetering van de gebruikerservaring. Dit document legt uit welke gegevens in het kader van het programma worden verzameld en hoe deze worden gebruikt. Wij verzoeken u vriendelijk dit document zorgvuldig te lezen en volledig te begrijpen voordat u uw toestemming geeft. U kunt uw toestemming op elk moment intrekken door de instellingen te wijzigen in 'Voorkeuren - Gebruikerservaring'.",
	...
	"ko_KR": {
		...
		"t150": "전체 선택",
		"t151": "QIDI Tech사용자 경험 개선 프로그램 이용 약관",
		"t152": "당사는 3D 프린팅 커뮤니티에서 서로의 성공 및 실패 사례로부터 학습하여 자체 슬라이싱 매개변수와 설정을 조정합니다. QIDI Studio 역시 동일한 원칙을 따르며, 사용자들의 집단적인 성공과 어려움으로부터 배우고 지속적으로 성능을 개선합니다.",
		"t153": "QIDI Studio는 제품 및 서비스의 품질과 성능을 향상시키는 데 도움이 되도록 사용자 경험 개선 프로그램에 여러분을 초대합니다. 이 문서에서는 프로그램에서 수집될 데이터의 종류와 사용 방법에 대해 설명합니다. 동의하시기 전에 이 문서를 주의 깊게 읽고 완전히 이해해 주시기 바랍니다. \"환경설정 - 사용자 경험\"에서 설정을 변경하여 언제든지 동의를 철회할 수 있습니다.",
		"t154": "정보의 수집 및 이용",
		...
		"t169": "개인정보 보호",
		"t170": "QIDI Lab은 귀하의 개인정보 보호에 최선을 다하고 있습니다. 수집된 정보는 관련 법률에서 요구하는 경우를 제외하고는 제3자에게 공유되거나 공개되지 않습니다. 데이터는 명시된 목적을 달성하는 데 필요한 기간 동안만 보관되며, 법률에 따라 더 긴 보관 기간이 요구되는 경우는 예외입니다. 당사가 귀하의 데이터를 처리하는 방식에 대한 자세한 내용은 ",
		"t171": "개인정보 보호정책",
		"wk17": "밤부랩 아카데미",
		"wk18": "빠른 시작 튜토리얼",
		"wk19": "주제별 학습",
