...
bool ImGui::QDTInputScalar(const char *        label,
...
bool ImGui::QDTInputDouble(const char *label, double *v, double step, double step_fast, const char *format, ImGuiInputTextFlags flags, bool support_numerical_operation)
{
    ImGui::PushStyleColor(ImGuiCol_BorderActive, ImVec4(0.27f, 0.47f, 0.98f, 1.00f));   // change color
    flags |= ImGuiInputTextFlags_CharsScientific;
    bool qdt_input_scalar = QDTInputScalar(label, ImGuiDataType_Double, (void *) v, (void *) (step > 0.0 ? &step : NULL), (void *) (step_fast > 0.0 ? &step_fast : NULL), format,
