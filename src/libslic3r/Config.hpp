...
// When parsing a configuration value, if the old_value is not understood by this QIDIStudio version,
// it is being substituted with some default value that this QIDIStudio could work with.
...
public:
    ...
    // QDS: support scaler opt_default
...
public:
    ...
    std::string                         cli;
    //QDS: add cli command line params
...
public:
    ...
    //QDS support load from ini string
