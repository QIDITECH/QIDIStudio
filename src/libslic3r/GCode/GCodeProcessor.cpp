...
void GCodeProcessor::process_file(const std::string& filename, std::function<void()> cancel_callback)
{
    ...
    // parse the gcode file to detect its producer
    {
        ...
        if (m_producer == EProducer::QIDIStudio || m_producer == EProducer::Slic3rPE || m_producer == EProducer::Slic3r) {
            ...
            case 4:
                ...
                case '4':
                    ...
                    case '0':
                        switch (cmd[3]) {
                        //QDS
                        case '0': { process_M400(line); break; } // QDS delay
        ...
        if (! parse_number(command.substr(1), eid) || eid < 0 || eid > 254) {
            ...
            if (m_extruder_id != id) {
                if (id >= m_result.extruders_count)
                    ...
                    //QDS: increase filament change times
                    m_result.lock();
