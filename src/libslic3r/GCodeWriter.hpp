...
public:
    ...
    std::string set_pressure_advance(double pa, bool is_qdt_bowden = false) const;
    ...
    void set_is_qdt_printer(bool is_qdt_printer) { m_is_qdt_printer = is_qdt_printer; };
    //QDS:
...
private:
    ...
    //QDS: this flag is used to indicate whether the m_pos is real.
