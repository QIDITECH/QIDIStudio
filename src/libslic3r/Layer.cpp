...
{
    // QDS: backup raw slice for generating support
...
//QDS: use aabbtree to get distance
...
//QDS: method to simplify support path
...
coordf_t Layer::get_sparse_infill_max_void_area()
{
    ...
    for (auto layerm : m_regions) {
        ...
        //QDS: rough estimation and need to be optimized
