...
#define PHYSICAL_PRINTER        "physical_printer"
...
//QDS: iot preset type strings
#define PRESET_IOT_PRINTER_TYPE     "printer"
#define PRESET_IOT_FILAMENT_TYPE    "filament"
#define PRESET_IOT_PRINT_TYPE       "print"


//QDS: add json support
#define QDT_JSON_KEY_VERSION        "version"
#define QDT_JSON_KEY_IS_CUSTOM      "is_custom_defined"
#define QDT_JSON_KEY_URL            "url"
#define QDT_JSON_KEY_NAME           "name"
#define QDT_JSON_KEY_DESCRIPTION    "description"
#define QDT_JSON_KEY_FORCE_UPDATE   "force_update"
#define QDT_JSON_KEY_MACHINE_MODEL_LIST     "machine_model_list"
#define QDT_JSON_KEY_PROCESS_LIST   "process_list"
#define QDT_JSON_KEY_SUB_PATH       "sub_path"
#define QDT_JSON_KEY_FILAMENT_LIST  "filament_list"
#define QDT_JSON_KEY_MACHINE_LIST   "machine_list"
#define QDT_JSON_KEY_TYPE           "type"
#define QDT_JSON_KEY_FROM           "from"
#define QDT_JSON_KEY_SETTING_ID     "setting_id"
#define QDT_JSON_KEY_BASE_ID        "base_id"
#define QDT_JSON_KEY_USER_ID        "user_id"
#define QDT_JSON_KEY_FILAMENT_ID    "filament_id"
#define QDT_JSON_KEY_UPDATE_TIME    "updated_time"
#define QDT_JSON_KEY_INHERITS       "inherits"
#define QDT_JSON_KEY_INCLUDES       "include"
#define QDT_JSON_KEY_INSTANTIATION  "instantiation"
#define QDT_JSON_KEY_NOZZLE_DIAMETER            "nozzle_diameter"
#define QDT_JSON_KEY_PRINTER_TECH                 "machine_tech"
...
#define QDT_JSON_KEY_USE_DOUBLE_EXTRUDER_DEFAULT_TEXTURE  "use_double_extruder_default_texture"
#define QDT_JSON_KEY_BOTTOM_TEXTURE_RECT        "bottom_texture_rect"
#define QDT_JSON_KEY_BOTTOM_TEXTURE_RECT_LONGER  "bottom_texture_rect_longer"
...
public:
    ...
    struct PrinterModel {
        ...
        std::string                 id;
        std::string                 name;
        //QDS: this is internal id for the printer. Currently only used for searching in database
        std::string                 model_id;
...
public:
    ...
    //QDS: add type for project-embedded
...
//        assert(opt != nullptr);
    ...
    bool is_qdt_vendor_preset(PresetBundle *preset_bundle);
    ...
    // QDS: move constructor to public
...
struct PresetConfigSubstitutions {
    ...
    enum class Source {
        UserFile,
        ConfigBundle,
        //QDS: add cloud and project type
        UserCloud,
        ProjectFile,
    };
...
public:
    ...
    //QDS: add project embedded presets logic
    ...
    Preset&         get_selected_preset() {
        //QDS fix crash when m_idx_selected == -1, give a default value
...
//        update_saved_preset_from_current_preset();
    ...
    // QDS return real pointer if set real = true
...
protected:
    ...
    //QDS: add operator= logic insteadof default
...
class PhysicalPrinterCollection : public PresetCollection
{
public:
