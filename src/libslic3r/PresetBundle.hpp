...
public:
    ...
    //QDS: add API to get previous machine
    ...
    //QDS: add a function to export current configbundle as default
    //void export_current_configbundle(const std::string &path);
    //QDS: add a function to export system presets for cloud-slicer
