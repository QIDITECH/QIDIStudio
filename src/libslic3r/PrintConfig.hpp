...
// QDS: reduce infill retraction mode
...
public:
    ...
    //QDS special case Support G/ Support W
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    //QDS auto hole contour compensation
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionInts,                temperature_vitrification))  //QDS
    ((ConfigOptionFloatsNullable,      filament_ramming_travel_time))  //QDS
    ((ConfigOptionIntsNullable,        filament_pre_cooling_temperature))// QDS
    ...
    ((ConfigOptionBool,                qdt_bed_temperature_gcode))
...
//#endif
    ...
    //y58
    ((ConfigOptionBool,                support_box_temp_control))
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    //w13
    ((ConfigOptionInts,               additional_cooling_fan_speed_unseal))
    ...
    ((ConfigOptionInts,               box_temperature_range_low))
    ((ConfigOptionInts,               box_temperature_range_high))
    ...
    // QDS: change wipe_tower_x and wipe_tower_y data type to floats to add partplate logic
    ...
    // QDS: not in any preset, calculated before slicing
