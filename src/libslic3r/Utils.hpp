...
//QDS: convert 0.1.3.4 version format to 00.01.03.04 format, like AA.BB.CC.DD
...
// QDT: true: succeed create or dir exists; false: fail to create
...
inline std::string get_qdt_time_dhms(float time_in_secs)
{
    int days = (int)(time_in_secs / 86400.0f);
    time_in_secs -= (float)days * 86400.0f;
    int hours = (int)(time_in_secs / 3600.0f);
...
inline std::string get_qdt_monitor_time_dhm(float time_in_secs)
{
    int days = (int)(time_in_secs / 86400.0f);
    time_in_secs -= (float)days * 86400.0f;
    int hours = (int)(time_in_secs / 3600.0f);
...
inline std::string get_qdt_finish_time_dhm(float time_in_secs, bool use_12h_format = false)
{
...
inline std::string get_qdt_remain_time_dhms(float time_in_secs)
{
    int days = (int) (time_in_secs / 86400.0f);
    time_in_secs -= (float) days * 86400.0f;
    int hours = (int) (time_in_secs / 3600.0f);
...
bool qdt_calc_md5(std::string &filename, std::string &md5_out);
