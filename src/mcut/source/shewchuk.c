...
REAL permanent;
{
  ...
  int axtqdten, axtcclen, aytqdten, aytcclen;
  REAL bxtaa[8], bxtcc[8], bytaa[8], bytcc[8];
  int bxtaalen, bxtcclen, bytaalen, bytcclen;
  REAL cxtaa[8], cxtbb[8], cytaa[8], cytbb[8];
  int cxtaalen, cxtqdten, cytaalen, cytqdten;
  ...
  if (adxtail != 0.0) {
    ...
    axtqdten = scale_expansion_zeroelim(4, bb, adxtail, axtbb);
    temp16clen = scale_expansion_zeroelim(axtqdten, axtbb, -cdy, temp16c);
  ...
  if (adytail != 0.0) {
    ...
    aytqdten = scale_expansion_zeroelim(4, bb, adytail, aytbb);
    temp16blen = scale_expansion_zeroelim(aytqdten, aytbb, cdx, temp16b);
  ...
  if (cdxtail != 0.0) {
    ...
    cxtqdten = scale_expansion_zeroelim(4, bb, cdxtail, cxtbb);
    temp16blen = scale_expansion_zeroelim(cxtqdten, cxtbb, ady, temp16b);
  ...
  if (cdytail != 0.0) {
    ...
    cytqdten = scale_expansion_zeroelim(4, bb, cdytail, cytbb);
    temp16clen = scale_expansion_zeroelim(cytqdten, cytbb, -adx, temp16c);
