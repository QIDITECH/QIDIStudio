                                      ...
                                      const wxString &current_version)
{
    m_heading_label->SetLabel(
        wxString::Format(_L("New QIDI Studio Beta Available") + wxString(": %s"), available_version));

    m_version_label->SetLabel(
        wxString::Format(_L("Current Version") + wxString(": %s"), current_version));

    m_overview_label->SetLabel(
        _L("QIDI Studio Beta gives you early access to upcoming features, improvements, optimizations, and bug fixes before they are released in the stable version of QIDI Studio. "
    ...
    createDetailItem(m_detail_sizer, m_detail_panel, 1,
        ...
        _L("As a beta release, some features may still be under development, and you may occasionally encounter bugs, unexpected behavior, or incomplete functionality. "
            "To prevent conflicts with the stable release, QIDI Studio Beta uses a separate configuration folder "
            "(Help -> Show Configuration Folder) and operates independently from the standard version of QIDI Studio."),
    ...
    createDetailItem(m_detail_sizer, m_detail_panel, 2,
        ...
        _L("By using the Beta version and sharing feedback, bug reports, and suggestions, you can help QIDI Tech improve stability, compatibility, and future features before the official release."));
