...
enum class ToolHeadNameCase {
    TitleCase    = 0,  // [0] "Main Extruder"  ¡ª panel titles, section headers
    SentenceCase = 1,  // [1] "Main extruder"  ¡ª static box labels
    LowerCase    = 2   // [2] "main extruder"  ¡ª inline text, sentence concatenation
};
