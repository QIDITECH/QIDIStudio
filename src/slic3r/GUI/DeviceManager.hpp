...
public:
    ...
    static bool is_qdt_filament(std::string tag_uid);
    ...
    QDTSliceInfo* slice_info {nullptr};
    ...
    QDTSubTask* subtask_;
    QDTModelTask *model_task { nullptr };
    ...
    QDTSubTask* get_subtask();
    QDTModelTask* get_modeltask();
    void set_modeltask(QDTModelTask* task);
