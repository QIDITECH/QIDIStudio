...
//   2. QDT official colour code surfacing,
      ...
      types: [
        {
          ...
          items: [
            { series: 'Basic',       filament_id: 'GFL00', setting_id: 'QDT_PLA_BASIC' },
            { series: 'Translucent', filament_id: 'GFL01', setting_id: 'QDT_PLA_TRANSLUCENT' },
          ],
        },
        {
          name: 'PETG Basic',
          series: ['Basic'],
          items: [
            { series: 'Basic', filament_id: 'GFG00', setting_id: 'QDT_PETG_BASIC' },
          ],
        },
      ],
    },
...
const CANDIDATES_BY_FILA_ID: Record<string, CandidateColor[]> = {
  // QDT PLA Basic - 3 single + 1 multicolor.
  QDT_PLA_BASIC: [
  ...
  // QDT PLA Translucent - 2 single + 1 gradient.
  QDT_PLA_TRANSLUCENT: [
...
const FILA_TYPE_BY_FILA_ID: Record<string, string> = {
  QDT_PLA_BASIC: 'PLA Basic',
  QDT_PLA_TRANSLUCENT: 'PLA Basic',
  QDT_PETG_BASIC: 'PETG Basic',
...
let SPOOLS: Spool[] = [
  {
    spool_id: 'sp-1', brand: 'QIDI', material_type: 'PLA Basic', series: 'Basic',
    ...
    setting_id: 'QDT_PLA_BASIC',
  },
  {
    spool_id: 'sp-2', brand: 'QIDI', material_type: 'PLA Basic', series: 'Basic',
  ...
  {
    spool_id: 'sp-3', brand: 'QIDI', material_type: 'PLA Basic', series: 'Translucent',
    ...
    setting_id: 'QDT_PLA_TRANSLUCENT',
  },
  {
  ...
  ams_units: [
    {
      ...
      trays: [
        { slot_id: '0', is_exists: true, tag_uid: 'RFID-A1',
          setting_id: 'QDT_PLA_BASIC', fila_type: 'PLA',
          color: '#FF911A', colors: ['#FF911A'], color_type: 2,
          weight: 850, remain: 85, diameter: 1.75, is_qdt: true,
          sub_brands: 'QIDI' },
        { slot_id: '1', is_exists: true, tag_uid: 'RFID-A2',
          setting_id: 'QDT_PLA_BASIC', fila_type: 'PLA',
          color: '#3F8BFF', colors: ['#3F8BFF', '#FF5BB0'], color_type: 1,
          weight: 720, remain: 72, diameter: 1.75, is_qdt: true,
          sub_brands: 'QIDI' },
        { slot_id: '2', is_exists: true, tag_uid: 'RFID-A3',
          setting_id: 'QDT_PLA_TRANSLUCENT', fila_type: 'PLA',
          color: '#FF7B5A', colors: ['#FF7B5A', '#FFD18C'], color_type: 0,
          weight: 600, remain: 60, diameter: 1.75, is_qdt: true,
          sub_brands: 'QIDI' },
