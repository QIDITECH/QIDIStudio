...
function getDisplayedTotalWeight(s: Spool) {
  ...
  // QIDI PLA Basic spool stores 1250 g initial + 250 g empty, producing
...
export function SpoolTable({
  ...
  // row tail reads it to surface official colour name + QDT fila code for
                      ...
                      <div className="flex flex-col gap-[2px] min-w-0">
                        ...
                        <div className="flex items-center gap-1 text-xs text-fm-text-secondary opacity-70 leading-[19px] min-w-0">
                          ...
                          {(() => {
                            ...
                            // for both colorName and QDT fila code; this gives
