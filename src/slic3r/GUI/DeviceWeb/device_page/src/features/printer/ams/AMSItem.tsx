    ...
    return (
        <div ref={originRef} className="relative w-[16.375rem] h-[10.5rem]">
            ...
            <div className="absolute top-[2.75rem] left-[1rem] right-[1rem] flex flex-row justify-evenly items-center">
                <QIDISlotItem slotRef={slotRef0} percent={10} />
                <QIDISlotItem slotRef={slotRef1} percent={20} />
                <QIDISlotItem slotRef={slotRef2} percent={50} />
                <QIDISlotItem slotRef={slotRef3} percent={70} />
            </div>
        </div>
    );
}