...
import QIDISlotItem from "./QIDISlot";
...
export default function AMSLite() {
    ...
    return (
        <div className="relative w-[10.25rem] h-[13rem]">
            ...
            <QIDISlotItem percent={10} className="absolute top-0 left-[0.2rem]" />
            <QIDISlotItem percent={10} className="absolute top-0 right-[0.2rem]" />
            <QIDISlotItem percent={10} className="absolute top-[6.875rem] left-[0.2rem]" />
            <QIDISlotItem percent={10} className="absolute top-[6.875rem] right-[0.2rem]" />
