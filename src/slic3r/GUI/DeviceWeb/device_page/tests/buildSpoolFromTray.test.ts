    ...
    types: [
      {
        ...
        series: ['Basic'],
        items: [
          { series: 'Basic', filament_id: 'GFA00', setting_id: 'GFA00', name: 'QIDI PLA Basic' },
      ...
      },
      {
        ...
        series: ['HF'],
        items: [
          { series: 'HF', filament_id: 'GFG02', setting_id: 'GFG02', name: 'QIDI PETG HF' },
        ],
      },
    ],
  },
...
assert.equal(r1.brandName, 'QIDI', 'brand resolved from setting_id');
...
assert.equal(built1.payload.brand, 'QIDI');
...
assert.equal(updates[0].brand, 'QIDI',
