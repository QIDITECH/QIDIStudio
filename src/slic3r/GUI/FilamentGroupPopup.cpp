...
static const wxColour GreenColor = wxColour("#4479fb");
...
{
    const wxString video_url = "https://e.qiditech.com/t?c=HDB24RlwSmt77YFH";
...
{
    const wxString video_url = "https://e.qiditech.com/t?c=fwWqpBg37Liel92N";
    if (wxLaunchDefaultBrowser(video_url)){
...
{
    const wxString wiki_url = "https://e.qiditech.com/t?c=mOkvsXkJ9pldGYp9";
