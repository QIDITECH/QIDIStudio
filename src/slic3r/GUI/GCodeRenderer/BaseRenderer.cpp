...
namespace Slic3r
{
    namespace GUI
    {
        ...
        {
            //y55
            bool Slic3r::GUI::gcode::BaseRenderer::is_show_speed = false;
            ...
            void BaseRenderer::load(const GCodeProcessorResult& gcode_result, const Print& print, const BuildVolume& build_volume, const std::vector<BoundingBoxf3>& exclude_bounding_box, bool initialized, ConfigOptionMode mode, bool only_gcode)
            {
                ...
                else if (&wxGetApp() && wxGetApp().app_config->get_bool("show_shells_in_preview")) { // QDS: load shell at helio_gcode
            ...
            void BaseRenderer::render_legend(float& legend_height, int canvas_width, int canvas_height, int right_margin)
            {
                ...
                auto append_item = [icon_size, &imgui, imperial_units, &window_padding, &draw_list, &checkbox_offset, this](
                    ...
                    std::function<void()> callback = nullptr)
                    {
                        ...
                        if (callback) {
                            ...
                            ImGui::PushStyleColor(ImGuiCol_BorderActive, ImVec4(0.27f, 0.47f, 0.98f, 1.00f));   //y73
                            ...
                            if (checkbox) {
                                ...
                                ImGui::PushStyleColor(ImGuiCol_CheckMark, ImVec4(0.27f, 0.47f, 0.98f, 1.00f));  //y73
                ...
                ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4(0.27f, 0.47f, 0.98f, 1.00f));
                ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4(0.27f, 0.47f, 0.98f, 0.78f));
