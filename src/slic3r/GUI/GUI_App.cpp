            ...
            CallAfter([this, dev_id, msg] {
                ...
                if (MachineObject* obj = this->m_device_manager->get_user_machine(dev_id)) {
                    ...
                    if (sel && sel->get_dev_id() == dev_id) {
                        ...
                        // STUDIO-18155: AMS ״̬�仯�����Ĳ�ͬ�������� store + �������ƶˣ�
...
//#endif
    ...
    BOOST_LOG_TRIVIAL(info) << boost::format("gui mode, Current QIDIStudio Version %1%")%SLIC3R_VERSION << ", BuildTime " << SLIC3R_BUILD_TIME;
...
void GUI_App::link_to_lan_only_wiki()
{
    ...
    if (country_code == "US") {
        url = "https://wiki.qidi3d.com/en/Q2/wifi";
    }
    else if (country_code == "CN") {
        url = "https://wiki.qidi3d.com/zh/Q2/wifi";
    }
    else {
        url = "https://wiki.qidi3d.com/en/Q2/wifi";
    }
...
void GUI_App::request_user_logout()
{
    ...
    if (m_agent && m_agent->is_user_login()) {
        ...
        // STUDIO-18155: �� AMS auto-push �����˱��������˺� A �� cooldown
        // Ӱ������˺� B ���һ�� sync ���� push ��ʱ����
...
int GUI_App::request_user_unbind(std::string dev_id)
{
    ...
    if (m_agent) {
        ...
        BOOST_LOG_TRIVIAL(info) << "request_user_unbind, dev_id = " << QDTCrossTalk::Crosstalk_DevId(dev_id) << ", result = " << result;
        return result;
    }
    return result;
}
