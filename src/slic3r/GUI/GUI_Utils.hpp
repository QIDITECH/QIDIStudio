...
{
public:
    WikiPanel(wxWindow *parent, const wxString &wiki_text = wxString("Wiki"), const wxString &tooltip = wxEmptyString, const std::string &wiki_url = "https://wiki.qidi3d.com/en/home");
    ~WikiPanel() = default;
