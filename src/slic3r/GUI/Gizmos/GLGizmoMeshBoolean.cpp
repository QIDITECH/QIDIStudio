...
void GLGizmoMeshBoolean::on_render()
{
    ...
    // y96
    float tool_color[3] = { 68.0f/255.0f , 121.0f / 255.0f, 251.0f / 255.0f};
...
void GLGizmoMeshBoolean::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    auto selectable = [this](const std::string& label, bool selected, const ImVec2& size_arg) {
        ...
        if (selected || hovered) {
            ...
            ImGui::PushStyleColor(ImGuiCol_Button, { 68.0f/255.0f , 121.0f / 255.0f, 251.0f / 255.0f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 68.0f/255.0f , 121.0f / 255.0f, 251.0f / 255.0f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 68.0f/255.0f , 121.0f / 255.0f, 251.0f / 255.0f, 1.0f });
        }
        else {
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 68.0f/255.0f , 121.0f / 255.0f, 251.0f / 255.0f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 68.0f/255.0f , 121.0f / 255.0f, 251.0f / 255.0f, 1.0f });
    ...
    if (m_operation_mode == MeshBooleanOperation::Union)
    {
        ...
        m_imgui->qdt_checkbox(_L("Delete input"), m_diff_delete_input);
        ...
        m_imgui->qdt_checkbox(_L("Delete input"), m_inter_delete_input);
