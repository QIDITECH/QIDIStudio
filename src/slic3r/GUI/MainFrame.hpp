...
class MainFrame : public DPIFrame
{
    ...
    {
        //QDS GUI refactor: remove unused layout
        Unknown,
        Old,
        //New,
        //Dlg,
...
public:
    ...
    // QDS
    QDTTopbar* topbar() { return m_topbar; }
    ...
    void        show_calibration_button(bool show, bool is_QDT);
    ...
    //QDS: hint when jump to 3Deditor under preview only mode
    ...
    void show_device(bool bQDTPrinter);
