...
void NotificationManager::qdt_show_seqprintinfo_notification(const std::string &text)
{
    NotificationData data{NotificationType::QDTSeqPrintInfo, NotificationLevel::PrintInfoNotificationLevel, QDT_NOTICE_MAX_INTERVAL, text};
