...
wxBoxSizer* ObjColorDialog::create_btn_sizer(long flags,bool exist_error)
{
    ...
    //         bool is_zh = wxGetApp().app_config->get("language") == "zh_CN";
            ...
            //     if (is_zh) {
            //         wxLaunchDefaultBrowser("https://wiki.qidi3d.com/zh/qidi-studio/Standard-3MF-File-Color-Parsing");
            //     } else {
            //         wxLaunchDefaultBrowser("https://wiki.qidi3d.com/en/qidi-studio/Standard-3MF-File-Color-Parsing");
            //     }
            // } else {//obj
            //     if (is_zh) {
            //         wxLaunchDefaultBrowser("https://wiki.qidi3d.com/zh/software/qidi-studio/import_obj");
            //     } else {
            //         wxLaunchDefaultBrowser("https://wiki.qidi3d.com/en/software/qidi-studio/import_obj");
            //     }
    //         }
    //     });
