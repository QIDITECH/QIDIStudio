...
public:
    ...
    //QDS: export the extra colume widget
    wxWindow*	extra_widget_win {nullptr};
    //QDS: add api to get the first option's key
...
public:
	...
	// QDS. Change private to protected to make change_opt_value() method available to
	// its child class.
protected:
...
// QDS. Add ExtruderOptionsGroup to change all members in vector option.
