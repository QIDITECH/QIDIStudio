    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(42 * wxGetApp().em_unit(), -1)), p(new priv(parent))
{
    ...
    // add printer
    {
        ...
        //     wxLaunchDefaultBrowser("https://wiki.qiditech.com/en/x1/manual/compatibility-and-parameter-settings-of-filaments");
        // });
    ...
    checkbox->Bind(wxEVT_TOGGLEBUTTON, [checkbox](wxCommandEvent& evt) {
...
void Sidebar::update_presets(Preset::Type preset_type)
{
    ...
    case Preset::TYPE_PRINTER:
    {
        ...
        //B
        wxGetApp().mainframe->show_calibration_button(isQDT);
...
// QDS. Move logic from Plater::on_extruders_change() to Sidebar::on_filaments_change().
...
void Sidebar::add_filament() {
    // QDS: limit filament choices to 16
...
void Plater::priv::on_select_preset(wxCommandEvent &evt)
{
    ...
    // QDS:Save the plate parameters before switching
...
void Plater::_calib_pa_line(const Calib_Params& params)
{
    ...
    const double external_perimeter_acceleration = print_config->get_abs_value("outer_wall_acceleration");
    ...
    double       pa_travel_speed = print_config->get_abs_value("initial_layer_speed") * 60;
...
void Plater::_calib_pa_pattern(const Calib_Params &params)
{
    ...
    */
    ...
    const double speed_perimeter = print_config->get_abs_value("inner_wall_speed");
    const double speed_fast = print_config->get_abs_value("outer_wall_speed") * 60;
    const double speed_first_layer = print_config->get_abs_value("initial_layer_speed") * 60;
...
void Plater::calib_flowrate(int pass,double input_value)
{
   ...
   // else
    ...
    if(pass == 1)
        filament_config->set_key_value("filament_flow_ratio", new ConfigOptionFloats{ 1.0 });
    else
        filament_config->set_key_value("filament_flow_ratio", new ConfigOptionFloats{ input_value });
...
void Plater::show_object_info()
{
    ...
    if (selection.is_wipe_tower()) {
        ...
        notify_manager->qdt_show_objectsinfo_notification(info_text, false, !(p->current_panel == p->view3D), _u8L("View Wiki for more information"), [](wxEvtHandler*) {
            wxGetApp().open_browser_with_warning_dialog("https://wiki.qiditech.com/en/software/qidi-studio/multi-color-printing");
            return false;
            });
        return;
    }
