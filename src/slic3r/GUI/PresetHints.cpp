...
{
	std::string out;
    //QDS: don't show cooling_description now
    /*
...
{
    std::string out;
    //QDS: don't show maximum_volumetric_flow_description now
    /*
...
{
    std::string out;
    //QDS: don't show recommended_thin_wall_thickness description now
    /*
    const DynamicPrintConfig &print_config    = preset_bundle.prints   .get_edited_preset().config;
    const DynamicPrintConfig &printer_config  = preset_bundle.printers .get_edited_preset().config;
...
{
    std::string out;
    //QDS: don't show top_bottom_shell_thickness_explanation now
    /*
    const DynamicPrintConfig &print_config    = preset_bundle.prints   .get_edited_preset().config;
    const DynamicPrintConfig &printer_config  = preset_bundle.printers .get_edited_preset().config;
