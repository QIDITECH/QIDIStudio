...
class PrinterFileSystem : public wxEvtHandler, public boost::enable_shared_from_this<PrinterFileSystem>, QIDILib
{
...
private:
    ...
    void HandleResponse(boost::unique_lock<boost::mutex> &l, QIDI_Sample const &sample);
