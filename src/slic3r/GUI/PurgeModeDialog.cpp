...
static const wxColour BorderSelectedColor = wxColour("#4479fb");
    ...
    : DPIDialog(parent, wxID_ANY, _L("Purge Mode Settings"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE), m_dialog_type(dialog_type)
{
    ...
    if (!is_fast_mode) {
        ...
        wiki->SetWikiUrl("https://wiki.qidi3d.com/en/software/qidi-studio/print-settings/prime-tower");
    ...
    StateColor ok_btn_bg(
        ...
        std::pair<wxColour, int>(wxColour("#4479fb"), StateColor::Normal)
    );
    ...
    ok_btn->SetBorderColor(wxColour("#4479fb"));
