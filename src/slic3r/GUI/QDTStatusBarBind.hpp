...
namespace Slic3r {
class QDTStatusBarBind : public ProgressIndicator
{
...
public:
    QDTStatusBarBind(wxWindow *parent = nullptr, int id = -1);
    ~QDTStatusBarBind() = default;
    ...
    void        stop_busy();
    void        set_cancel_callback_fina(QDTStatusBarBind::CancelFn ccb);
