#ifndef QDTStatusBarPrint_HPP
#define QDTStatusBarPrint_HPP
...
class QDTStatusBarPrint : public ProgressIndicator
{
...
public:
    QDTStatusBarPrint(wxWindow *parent = nullptr, int id = -1);
    ~QDTStatusBarPrint() = default;
    ...
    void        stop_busy();
    void        set_cancel_callback_fina(QDTStatusBarPrint::CancelFn ccb);
...
namespace GUI {
using Slic3r::QDTStatusBarPrint;
}
