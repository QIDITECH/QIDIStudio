    ...
    : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Release Note"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    auto sm = create_scaled_bitmap("QIDIStudio", nullptr,  70);
    ...
    : DPIDialog(static_cast<wxWindow*>(wxGetApp().mainframe), wxID_ANY, _L("Network plug-in update"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    auto sm = create_scaled_bitmap("QIDIStudio", nullptr, 55);
    ...
    operation_tips = new ::Label(this, Label::Body_12, _L("Click OK to update the Network plug-in when QIDI Studio launches next time."), LB_AUTO_WRAP);
...
UpdateVersionDialog::UpdateVersionDialog(wxWindow *parent)
    : DPIDialog(parent, wxID_ANY, _L("New version of QIDI Studio"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX | wxRESIZE_BORDER)
{
    std::string icon_path = (boost::format("%1%/images/QIDIStudioTitle.ico") % resources_dir()).str();
    SetIcon(wxIcon(encode_path(icon_path.c_str()), wxBITMAP_TYPE_ICO));
    ...
    m_button_download->SetBackgroundColor(btn_bg_blue);
...
{
    //qds check whether the web display is used
    ...
    :DPIFrame(parent, id, title, pos, size, style)
{
    ...
    auto sizer_button = new wxBoxSizer(wxHORIZONTAL);
    // y96
    btn_bg_blue = StateColor(std::pair<wxColour, int>(wxColour(95, 82, 253), StateColor::Pressed), std::pair<wxColour, int>(wxColour(129, 150, 255), StateColor::Hovered),
        std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
...
void ConfirmBeforeSendDialog::edit_cancel_button_txt(const wxString& txt, bool switch_green)
{
    ...
    if (switch_green)
    {
        StateColor btn_bg_blue(std::pair<wxColour, int>(wxColour(54, 97, 201), StateColor::Pressed),
                                ...
                                std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
        m_button_cancel->SetBackgroundColor(btn_bg_blue);
...
{
    m_button_ok->Enable();
    StateColor btn_bg_blue(std::pair<wxColour, int>(wxColour(129, 150, 255), StateColor::Pressed), std::pair<wxColour, int>(wxColour(129, 150, 255), StateColor::Hovered),
        std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
    m_button_ok->SetBackgroundColor(btn_bg_blue);
    m_button_ok->SetBorderColor(btn_bg_blue);
}
                ...
                wxCAPTION | wxCLOSE_BOX)
{
    ...
    comfirm_before_enter_text = _L("1. Please confirm QIDI Studio and your printer are in the same LAN.");
    ...
    wiki->SetForegroundColour(wxColour(68, 121, 251));
    ...
    wiki->Bind(wxEVT_LEFT_DOWN, [this](auto &e) {
        ...
        if (wxGetApp().app_config->get("region") =="China") {
            url = "https://wiki.qiditech.com/zh/software/qidi-studio/failed-to-send-print-files";
        }
        else {
            url = "https://wiki.qiditech.com/en/software/qidi-studio/failed-to-send-print-files";
        }
    ...
    m_status_bar = std::make_shared<QDTStatusBarSend>(this);
    ...
    : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Enable Helio"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
     ...
     Label* m_description_line5 = new Label(this, Label::Body_13,
         _L("1.Copy or use any part of this product outside the authorized scope of Helio Additive and QIDI."));
