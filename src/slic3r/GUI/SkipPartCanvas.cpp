...
void SkipPartCanvas::Render()
{
    ...
    // stencil1 => unchecked
    draw_shape(uncheckd_stencil, psUnCheck, ColorRGB{68 / 255.f, 121 / 255.f, 251 / 255.f});
...
void _QDS_3MF_Base::add_error(const std::string &error) const
{
    boost::unique_lock l(mutex);
    m_errors.push_back(error);
}
void _QDS_3MF_Base::clear_errors() { m_errors.clear(); }

void _QDS_3MF_Base::log_errors()
{
