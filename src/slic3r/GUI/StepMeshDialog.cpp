                ...
                wxDEFAULT_DIALOG_STYLE /* | wxRESIZE_BORDER*/), m_file(file)
{
    ...
    std::string icon_path = (boost::format("%1%/images/QIDIStudioTitle.ico")
    ...
    wxStaticText *tips = new wxStaticText(this, wxID_ANY, _L("See QIDI Tech Wiki"));
    ...
    tips->Bind(wxEVT_LEFT_DOWN, [this](wxMouseEvent& e) {
        wxLaunchDefaultBrowser("https://wiki.qidi3d.com/zh/software/qidi-studio/expand/step");
    });
