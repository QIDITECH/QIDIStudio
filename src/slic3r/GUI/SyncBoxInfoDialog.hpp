#ifndef _SyncBoxInfo_DIALOG_H_
#define _SyncBoxInfo_DIALOG_H_
...
public:
    ...
    bool do_ams_mapping();
    void deal_only_exist_ext_spool();
...
class SyncNozzleAndBoxDialog : public Slic3r::GUI::BaseTransparentDPIFrame
{
public:
    struct InputInfo
    {
    ...
    SyncNozzleAndBoxDialog(InputInfo &input_info);
    ~SyncNozzleAndBoxDialog() override;
...
class FinishSyncBoxDialog : public Slic3r::GUI::BaseTransparentDPIFrame
{
public:
    struct InputInfo
    {
    ...
    FinishSyncBoxDialog(InputInfo &input_info);
    ~FinishSyncBoxDialog() override;
    void deal_ok();
    void update_info(InputInfo &info);
