...
public:
	...
	// QDS. Add is_extruder_og parameter.
...
public:
	...
	void			update_dirty();
	//QDS update plater presets if update_plater_presets = true
    ...
    void            toggle_line(const std::string &opt_key, bool toggle, int opt_index = -1); // QDS: hide some line
