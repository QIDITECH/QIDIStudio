...
TaskStateInfo::TaskStateInfo(QDT::PrintParams param)
...
int TaskManager::start_print(const std::vector<QDT::PrintParams>& params, TaskSettings* settings)
{
...
static int start_print_test(QDT::PrintParams& params, OnUpdateStatusFn update_fn, WasCancelledFn cancel_fn, OnWaitFn wait_fn)
{
    int tick = 2;
