...
public:
    ...
    TaskStateInfo(const QDT::PrintParams param);
    ...
    QDT::PrintParams get_params() { return m_params; }

    QDT::PrintParams& params() { return m_params; }
...
public:
    ...
    int start_print(const std::vector<QDT::PrintParams>& params, TaskSettings* settings = nullptr);
