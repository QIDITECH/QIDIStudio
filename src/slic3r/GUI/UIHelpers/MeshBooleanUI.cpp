...
void MeshBooleanUI::draw_action_buttons()
{
    ...
    //y73
    // OK button (bulue)
    ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.27f, 0.47f, 0.98f, 1.00f));
    ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4(0.45f, 0.66f, 1.00f, 1.00f));
    ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4(0.00f, 0.26f, 1.00f, 1.00f));
...
void MeshBooleanUI::render_checkbox(const wxString& label, bool& value, bool enabled)
{
    ...
    if (m_imgui) {
        m_imgui->qdt_checkbox(label, value);
    } else {
...
void MeshBooleanUI::draw_progress_bar()
{
    ...
    set_centered_cursor_x(progress_width);
        ...
        // Progress bar styling (matching original QIDIStudio style)
    ImGui::PushStyleColor(ImGuiCol_PlotHistogram, ImVec4(0.27f, 0.47f, 0.98f, 1.00f)); // Green progress    //y73
