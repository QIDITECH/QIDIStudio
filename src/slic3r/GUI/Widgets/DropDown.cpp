...
DropDown::DropDown(std::vector<Item> &items)
    ...
    , selector_border_color(std::make_pair(0x4479fb, (int) StateColor::Hovered),
        std::make_pair(*wxWHITE, (int) StateColor::Normal))
    , selector_background_color(std::make_pair(0xe0ffff, (int) StateColor::Checked),
        std::make_pair(*wxWHITE, (int) StateColor::Normal))
{
}
