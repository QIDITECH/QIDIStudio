    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(91, 86, 248), StateColor::Pressed);
    border_color.append(wxColour(116, 168, 255), StateColor::Hovered);
    border_color.append(0x4479FB, StateColor::Normal);  // y96
    ...
    background_color.append(wxColour(91, 86, 248), StateColor::Pressed);
    background_color.append(wxColour(116, 168, 255), StateColor::Hovered);
    background_color.append(0x4479FB, StateColor::Normal);  // y96
