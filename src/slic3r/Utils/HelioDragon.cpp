...
{
    std::string query_body = R"( {
            "query": "query GetPrinters($page: Int) { printers(page: $page, pageSize: 20) { pages pageInfo { hasNextPage } objects { ... on Printer  { id name heatedChamber alternativeNames { qidistudio } } } } }",
            "variables": {"page": %1%}
		} )";
...
// V2: single material ¡ª createGcodeV2 mutation
...
// V3: multi-material ¡ª createGcodeV3 mutation
