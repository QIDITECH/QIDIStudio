...
std::string QDTCrossTalk::Crosstalk_UsrId(const std::string& uid)
{
...
std::string QDTCrossTalk::Encode_DevIp(const std::string& str, const std::string& rand)
{
...
std::string QDTCrossTalk::Decode_DevIp(const std::string& str, const std::string& rand)
{
    if (str.empty() || rand.empty()) {
        return str;
    }
...
bool QDT_Encrypt::AESEncrypt(unsigned char* src, unsigned src_len, unsigned char* encrypt,
...
bool QDT_Encrypt::AESDecrypt(unsigned char* encrypt,
...
static inline void s_qdt_fill_key_32(unsigned char(&key_out)[32], const std::string& key)
{
...
static inline void s_qdt_fill_iv_16(unsigned char(&iv_out)[AES_BLOCK_SIZE], const std::string& iv)
{
...
bool QDT_Encrypt::AES256CBC_Encrypt(unsigned char* src,
                                    unsigned src_len,
                                    ...
                                    const std::string& iv)
{
    ...
    s_qdt_fill_key_32(key_bytes, key);
...
bool QDT_Encrypt::AES256CBC_Decrypt(unsigned char* encrypt,
                                    unsigned encrypt_len,
                                    unsigned char* src,
                                    unsigned& out_len,
                                    const std::string& key,
