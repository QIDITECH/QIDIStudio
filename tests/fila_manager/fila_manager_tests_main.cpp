          ...
          "[fila_manager][colors][compat]")
{
    ...
    legacy["color_code"]  = "#4479FB";
    legacy["color_name"]  = "QIDI Blue";
...
#else // !QDT_TEST_HAS_WX — wx headers unavailable, mirror the spec table
