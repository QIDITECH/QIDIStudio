...
TEST_CASE("12_Hour_Time_Format", "[Timeutils]") {
    ...
    // Test get_qdt_finish_time_dhm with 12-hour format
    // Test with 1 hour remaining (3600 seconds)
    std::string finish_time_24h = get_qdt_finish_time_dhm(3600.0f, false);
    std::string finish_time_12h = get_qdt_finish_time_dhm(3600.0f, true);
